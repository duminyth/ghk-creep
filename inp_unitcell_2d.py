...
#abaqus cae noGUI=G:/01_Forschung/01_Creep/00_UMAT/UMAT_CLAUDE/Script/inp_unitcell_2d.py
...
path = 'G:/01_Forschung/01_Creep/00_UMAT/UMAT_CLAUDE/UnitCell_2D/time_increment'
os.mkdir(path)
os.chdir(path)
