...
!=======================================================================
     ...
     4 CELENT,DFGRD0,DFGRD1,NOEL,NPT,LAYER,KSPT,JSTEP,KINC)
      ...
      DOUBLE PRECISION A_CR,N_CR,M_CR,ECR0
...
!=======================================================================
      ...
      IF (NPROPS .GE. 10) THEN
        IF (PROPS(10) .GT. ZERO) DTIME_MAX_LOCAL = PROPS(10)
      END IF
      IF (NPROPS .GE. 11) THEN
        IF (PROPS(11) .GT. ZERO) DECR_MAX_SUB = PROPS(11)
      END IF
...
!     This is deliberately conservative.
     ...
     1    Q_TR .GT. TOL_CR) THEN
        ...
        DECR_BAR = A_CR*(Q_TR**N_CR)*(ECR_EFF_MID**M_CR)*DTIME
